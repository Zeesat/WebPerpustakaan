<?php
    ...
    $isMyLoans = is_current_path('/loans/my');
    ...
    <div class="max-w-[1240px] mx-auto flex justify-between items-center h-20 px-6">
        ...
        <nav class="hidden md:flex items-center gap-10">
            ...
            <?php if (auth_check() && ! auth_is_admin()): ?>
                <a class="<?= $isMyLoans ? $navLinkActive : $navLinkBase; ?>" href="<?= htmlspecialchars(url('/loans/my')); ?>">My Loans</a>
            <?php endif; ?>
            ...
            <?php if (auth_check()): ?>
                ...
                <div class="relative" id="user-dropdown-wrapper">
                    <button
                        ...
                        type="button"
                        class="flex items-center gap-3 border-l border-slate-200 pl-6 cursor-pointer hover:bg-slate-50 p-1.5 -m-1.5 rounded-lg transition-colors"
                        aria-haspopup="true"
                        aria-expanded="false"
                    >
                    ...
                    <div
                        ...
                        class="absolute right-0 top-full mt-2 w-52 bg-white rounded-xl border border-slate-200 shadow-lg py-1.5 z-[60] opacity-0 invisible -translate-y-2 transition-all duration-200 ease-out"
                        role="menu"
                    >
