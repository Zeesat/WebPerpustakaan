        ...
        <div class="w-full">
            ...
            <section class="relative flex items-center">
                ...
                <div class="w-full rounded-[32px] border border-white/70 bg-white/90 p-6 shadow-[0_30px_80px_rgba(0,44,120,0.12)] backdrop-blur md:p-10">
                    ...
                    <form action="/reset-password" class="mt-4 space-y-4" data-loading-form method="POST">
                        <?= csrf_field(); ?>
                        ...
                        <div class="grid gap-3">
                            <div class="grid gap-3 md:grid-cols-2">
                                <div>
                                    <label class="mb-1 block text-xs font-medium text-on-surface" for="password">New Password</label>
                                    <div class="relative">
